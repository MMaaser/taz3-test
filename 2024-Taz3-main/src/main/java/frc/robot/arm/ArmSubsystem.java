...
import static frc.robot.Constants.ARM_FWD_LIMIT;
import static frc.robot.Constants.ARM_JERK;
import static frc.robot.Constants.ARM_MAX_ACCEL;
import static frc.robot.Constants.ARM_MAX_VEL;
import static frc.robot.Constants.ARM_REV_LIMIT;
import static frc.robot.Constants.ARM_STATOR_LIMIT;
import static frc.robot.Constants.ARM_SUPPLY_LIMIT;
import static frc.robot.Constants.CANBUS_NAME;
import static frc.robot.Constants.armMotorID;
...
public class ArmSubsystem extends SubsystemBase{
    ...
    public ArmSubsystem () {
        ...
        m_arm = new TalonFX(armMotorID, CANBUS_NAME);
    ...
    /* This calles a 'long form' of MotionMagicVoltage */
