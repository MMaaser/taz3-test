...
public class ArmVisionTest extends Command {
 ...
 */
    ...
    public ArmVisionTest(ArmSubsystem armSub, VisionSubsystem visionSub) {
        ...
        */
        addRequirements(armSub, visionSub);
    }
    ...
    public void execute() {
        ...
        if (visionSub.isTargetVisible()){
        m_armSub.setArmMotionMagic(Constants.ARM_POSE_ONE/2); // changed for safety testing
        } else {
